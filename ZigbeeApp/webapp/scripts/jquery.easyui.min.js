...
}},rules:{hhmmtime:{validator:function(value){if(value.length!=5){return false;}
var reg = /^(0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9])$/;return reg.test(value);},message: "格式为HH:MM"},
email:{validator:function(_408){
