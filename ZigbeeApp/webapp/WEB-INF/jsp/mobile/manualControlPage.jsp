...
<body>
	<div class="easyui-panel" title="手动控制" style="width:985px; height:615px; padding:0 0 0 0; ">
		...
		<div class="tag_left">
			<table cellpadding="5">
				...
				<td>
					...
					<img id="linklight1" onclick="changeLight1()" src="${imagepath}/btn_on.jpg" <core:if test="${!(dto.curMode==2&&dto.light1Onoff==1)}">style="display:none;" </core:if>/>
					</a><a href="javascript:void(0)">
					<img id="linklight2" onclick="changeLight2()" src="${imagepath}/btn_off.jpg" <core:if test="${!(dto.curMode==2&&dto.light1Onoff==2)}">style="display:none;" </core:if>/>
					</a>
					<img id="linklight3" src="${imagepath}/btn_on_gray.jpg"  <core:if test="${!(dto.curMode==1&&dto.light1Onoff==1)}">style="display:none;" </core:if>/>
					<img id="linklight4" src="${imagepath}/btn_off_gray.jpg"  <core:if test="${!(dto.curMode==1&&dto.light1Onoff==2)}">style="display:none;" </core:if>/>
		...
		<div class="tag_right">
			...
			<div class="tag_right_4">
				<table cellpadding="5" style="float:right;">
				<tr>
					<td class="image"  style="text-align:center;padding:5px">
					<a href="javascript:void(0);">
						<img id="linkMode1" onclick="changeMode1()" src="${imagepath}/btn_auto.jpg" <core:if test="${dto.curMode==2}">style="display:none;" </core:if>/>
					</a><a href="javascript:void(0);">  	
					  	<img id="linkMode2" onclick="changeMode2()" src="${imagepath}/btn_manual.jpg" <core:if test="${dto.curMode==1}">style="display:none;" </core:if>/>
					</a>
						<img id="linkMode3" src="${imagepath}/btn_auto.jpg" style="display:none;"/>
					  	<img id="linkMode4" src="${imagepath}/btn_manual.jpg" style="display:none;"/>
					</td>
				</tr>
				</table>
			</div>
