...
<body>
	<div class="easyui-panel" title="视频显示" style="width: 870px">
		<div style="padding: 10px 10px 10px 10px">
			<form id="ff" method="post">
				<table cellpadding="5" class="display" >
					<tr>
						<th width="30%" class="easyui">视频名称</th>
                        <th width="30%" class="easyui">视频上传时间</th>
						<th width="40%" class="easyui">视频地址</th>
                    </tr>
                  <core:forEach items="${videoMessagesDto}" var="videoMessagesDto">
					<tr>
                        <td>${videoMessagesDto.videoName}</td>
                        <td>${videoMessagesDto.timestamp}</td>
                        <td>${videoMessagesDto.videoUrl}</td>
                    </tr>
                 </core:forEach> 
				</table>
			</form>
