 ...
 ************************************************************************************/
package com.zigbee.framework.common.exception;

/**
 * Defines a custom application exception with its error code, description and
 * root cause.
 */
public class ZigbeeSystemException extends RuntimeException {
     ...
     */
    public ZigbeeSystemException(String errCode, String description) {
        super(description);
     ...
     *            exception.
     */
    public ZigbeeSystemException(String errCode, String description, Throwable cause) {
